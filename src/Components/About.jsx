...
const About = () => {
    return (
        ...
        >
            ...
            >About
                <span className="underline-offset-4 decoration-1 under font-light"> Our Brand</span>
            </h1>
            <p className='text-gray-500 max-w-80 text-center mb-8'>Passionate About Properties, Dedicated to Your Vission</p>
                ...
                >
                    ...
                    <div>
                        ...
                        >Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                            Fugit numquam dicta odio possimus et quam! Possimus neque unde enim eius incidunt,
                            vero necessitatibus. Optio nobis quibusdam, harum facilis totam rerum.</p>
                        <button
                            className='bg-blue-500 rounded py-2 px-8 text-white'
                        >Learn more</button>
                    </div>
